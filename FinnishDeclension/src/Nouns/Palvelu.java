...
public class Palvelu {
	public HashMap<String, String> generateForms(String INVSTEM, String HARVOW){
		...
		forms.put("PAR SG", INVSTEM+HARVOW);
		...
		forms.put("GEN PL", INVSTEM+"jen" + "|"+INVSTEM+"iden" + "|"+INVSTEM+"itten");
		forms.put("PAR PL", INVSTEM+"j"+HARVOW + "|" + INVSTEM + "it"+HARVOW);
	...
	public static void main(String[] args) {
		//decl(palvelu, kaasuonkalo, a)
		//kaasuonkalo
		//decl(palvelu, jäätelö, ä)
		Palvelu p = new Palvelu();
		HashMap<String, String> forms = p.generateForms("jäätelö", "ä");
